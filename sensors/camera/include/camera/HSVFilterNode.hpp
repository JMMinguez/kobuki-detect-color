...
private:
  ...
  rclcpp::Publisher<geometry_msgs::msg::Vector3>::SharedPtr a_vector_pub_;
  geometry_msgs::msg::Vector3 attractive_vector_msg;

  rclcpp::Publisher<std_msgs::msg::Bool>::SharedPtr object_pub_;
  std_msgs::msg::Bool object_msg;
